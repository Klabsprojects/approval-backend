...
let file = "licenseLe1.controller";
    ...
    try {
       ...
       /*let x = query.password;
        ...
        if (query && query.length > 0) {
            results = await commonService.insertMany(db.licenseLe1, query);
        } else {
            results = await commonService.insertOne(db.licenseLe1, query);
        }
...
exports.list = async (req, res) => {
    ...
    try {
        ...
        let results;
        //if(req.query.phone)
            results = await commonService.findAll(db.licenseLe1, query);
...
exports.update = async (req, res) => {
    try {
        ...
        const results = await commonService.update(db.licenseLe1, query);
